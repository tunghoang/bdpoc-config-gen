...
def st_custom_dataframe(data, header, key=0):
  return custom_component(com_name="st_custom_dataframe", url=CUSTOM_DATAFRAME_PREVIEW, component_lib=st_custom_dataframe_lib, release=CUSTOM_DATAFRAME_RELEASE, data=data, header=header, key=key)
