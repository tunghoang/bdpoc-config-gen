...
def outstanding_tag_list(name, key=None, nMasks=[], oMasks=[], iMasks=[], fMasks=[], tags=[], tagDescriptions=[]):
  component_value = _outstanding_tag_list(name=name, key=key, default={}, nMasks=nMasks, oMasks=oMasks, iMasks=iMasks, fMasks=fMasks, tags=tags, tagDescriptions=tagDescriptions)
